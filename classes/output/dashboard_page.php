...
class dashboard_page implements renderable, templatable {
    ...
    protected function string_keys(): array {
        return [
            ...
            'act_kpi_avg',
            'act_kpi_avg_delta',
            'act_kpi_critical_delivery',
            'act_kpi_critical_delivery_sub',
            'act_kpi_low_coverage',
            'act_kpi_low_coverage_sub',
            'act_kpi_overdue_pending',
            'act_kpi_overdue_activities',
            'act_kpi_reach_average',
            'act_export_type',
            'act_export_due_date',
            'act_export_visibility',
            'act_export_tracked',
            'act_export_hidden',
            'act_export_visible',
            'act_export_empty',
            'act_tip_critical_delivery',
            'act_tip_low_coverage',
            'act_tip_overdue_pending',
            ...
            'gr_state_pending',
            'gr_state_overdue',
            'gr_no_missing_points',
            'gr_estimated_each_remaining',
            'gr_no_remaining_items',
            'gr_performance_list',
            'gr_showing_range',
            'gr_items_per_page',
            // ── Interventions tab ──
